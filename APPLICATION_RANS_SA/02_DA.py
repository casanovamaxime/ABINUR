...
write_fx_(fAx)
#SA A 
#Solve second forward
DA_TRUE = False
STATE = 'A'
fAx.interpolate(fAx/Qf)
qx = solve_SA_BorA(uvhfx,nuthfx,Qf,Re_s,qx,ux,px,nutx,phiux,phipx,phinutx,fAx,Q,h,d2x,dX,set_annotation,STATE,DA_TRUE)
write_qx(qx,STATE)
